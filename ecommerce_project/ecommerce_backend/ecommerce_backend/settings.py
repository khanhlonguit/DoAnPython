...
SECRET_KEY = 'django-insecure-l=p$#62nmg+cdib!r2a&u7h5&_70l57raj#o7*v_po*yhxaa=j'
...
# Thêm các cấu hình sau vào cuối file settings.py
...
EMAIL_HOST_PASSWORD = 'vero zigh ehsv hmtc'  # Mật khẩu email của bạn
